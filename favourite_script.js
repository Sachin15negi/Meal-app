...
// Functions to fetche and display all favourite meals
...
function addfavouriteMeals(meal, content) {
  content = `<div class = "meal-item d-flex flex-column align-items-center" id = "${meal.idMeal}">
    ...
    <button type="submit" id="remove-btn" class="btn btn-sm btn-outline-primary unfavourite-button"> Remove From Favourites </button>
    </div>`;
  favouriteMealContainer.innerHTML += content;
}

// function to remove favourites from local storage
